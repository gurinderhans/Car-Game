...
public class SmoothNetworkCharacter : MonoBehaviour {
	...
	private Vector3 current_veloc;

	private Vector3 correctPlayerPos = Vector3.zero;
	private Quaternion correctPlayerRot = Quaternion.identity;
	private Vector3 correct_veloc;
	...
	public void Update(){
		if(!networkView.isMine){
			...
			rigidbody.velocity = Vector3.Lerp(rigidbody.velocity, correct_veloc, Time.deltaTime * this.SmoothingDelay);
		}
	}
